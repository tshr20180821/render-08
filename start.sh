...
curl -sS https://packages.debian.org/bookworm/apache2 | grep '<h1>' | grep 'apache2' | cut -c 9-
curl -sS https://packages.debian.org/bookworm-updates/apache2 | grep '<h1>' | grep 'apache2' | cut -c 9-
curl -sS https://packages.debian.org/bookworm-backports/apache2 | grep '<h1>' | grep 'apache2' | cut -c 9-
curl -sS https://packages.debian.org/trixie/apache2 | grep '<h1>' | grep 'apache2' | cut -c 9-
curl -sS https://packages.debian.org/sid/apache2 | grep '<h1>' | grep 'apache2' | cut -c 9-
